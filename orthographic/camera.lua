...
M.PROJECTOR.SEMI_FIXED_AUTO = hash("SEMI_FIXED_AUTO")
...
-- 
projectors[M.PROJECTOR.SEMI_FIXED_AUTO] = function(camera_id, near_z, far_z, zoom)
	...
	local zoom_factor = math.max(ww / DISPLAY_WIDTH, wh / DISPLAY_HEIGHT) * zoom * dpi_ratio
